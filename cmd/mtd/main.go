...
$ mtd add-genesis-account cosmos1tse7r2fadvlrrgau3pa0ss7cqh55wrv6y9alwh 1000STAKE,1000nametoken
`),
		RunE: func(_ *cobra.Command, args []string) error {
			...
			if !common.FileExists(genFile) {
				return fmt.Errorf("%s does not exist, run `mtd init` first", genFile)
			}
