...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a Microtick testnet",
...
Example:
	mtd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "mtd",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "mtcli",
...
func InitTestnet(
	...
	microtickConfig := srvconfig.DefaultConfig()
	microtickConfig.MinGasPrices = minGasPrices
	...
	for i := 0; i < numValidators; i++ {
		...
		// TODO: Rename config file to server.toml as it's not particular to mt
		// (REF: https://github.com/cosmos/cosmos-sdk/issues/4125).
		microtickConfigFilePath := filepath.Join(nodeDir, "config/config.toml")
		srvconfig.WriteConfigFile(microtickConfigFilePath, microtickConfig)
	}
